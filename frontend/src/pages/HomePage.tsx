...
export const HomePage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] relative">
      {/* Environmental Ambient Light (Softly Refracted through Liquid Glass Navbar) */}
      <div className="absolute -top-12 left-1/2 -translate-x-1/2 w-full max-w-6xl h-44 bg-gradient-to-b from-[#FF6B35]/12 via-[#FF6B35]/3 to-transparent blur-2xl -z-10 pointer-events-none" />
