    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 animate-fade-in">
      ...
      <div className="card-glow rounded-3xl p-6 sm:p-8 border border-slate-800 relative overflow-hidden">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 relative z-10">
          <div className="flex items-center gap-5">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-600 via-indigo-600 to-cyan-500 flex items-center justify-center text-white shadow-lg shadow-blue-500/20 shrink-0">
            ...
            <div>
              ...
              <div className="text-[11px] text-slate-500 mt-1 flex items-center gap-2 font-mono">
                ...
                <span className="text-emerald-400 flex items-center gap-1">
                  <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" /> Active Local Session
                </span>
              </div>
            </div>
          </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3.5">
        <div className="card-glow p-4 rounded-2xl border border-slate-800 space-y-1">
          <div className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Saved Audits</div>
        ...
        <div className="card-glow p-4 rounded-2xl border border-slate-800 space-y-1">
          ...
          <div className="text-[10px] text-slate-500">Across local scans</div>
        </div>
        ...
        <div className="card-glow p-4 rounded-2xl border border-slate-800 space-y-1">
          <div className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Workspaces</div>
          <div className="text-2xl font-black text-purple-400 font-mono">{stats.projectsCount}</div>
          <div className="text-[10px] text-slate-500">Active project sets</div>
        </div>
        ...
        <div className="card-glow p-4 rounded-2xl border border-slate-800 space-y-1">
          <div className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Competitors</div>
          <div className="text-2xl font-black text-cyan-400 font-mono">{stats.competitorsCount}</div>
          <div className="text-[10px] text-slate-500">Saved benchmarks</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="card-glow rounded-3xl p-6 border border-slate-800 space-y-4">
          ...
          <div className="flex items-center gap-3">
            <label className="cursor-pointer inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-slate-900 border border-slate-700 hover:border-slate-600 text-xs font-semibold text-white transition">
